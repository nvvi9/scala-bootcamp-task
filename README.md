...
Your need to implement the `process` method in the [Solver.kt](src/main/kotlin/com/evolution/bootcamp/assignment/poker/Solver.kt)
class.

All the unit tests in [TexasHoldemSolverTest.kt](src/test/kotlin/com/evolution/bootcamp/assignment/poker/TexasHoldemSolverTest.kt),
[OmahaHoldemSolverTest.kt](src/test/kotlin/com/evolution/bootcamp/assignment/poker/OmahaHoldemSolverTest.kt), and
[FiveCardDrawSolverTest.kt](src/test/kotlin/com/evolution/bootcamp/assignment/poker/FiveCardDrawSolverTest.kt) should pass.
...
Once you are finished with the task, please click the `Complete task` link on <a href="https://app.codescreen.com/#/codescreentest62039cf6fd6ed2747226dae4" target="_blank">this screen</a>.